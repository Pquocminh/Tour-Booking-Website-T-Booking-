...
<head>
    ...
    <title>Staff Schedule Management | T-Booking</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <header class="hero-section">
        <div class="container">
            <h1 class="hero-title">Staff Schedule <span>Management</span></h1>
            <p class="hero-subtitle">Create new tour schedules, view participant details, or remove invalid schedules</p>
        </div>
    </header>
