        ...
        <section class="table-panel p-4 rounded-4 bg-white shadow-sm">
            <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-3">
                <div>
                    ...
                    <span class="badge bg-primary rounded-pill py-2 px-3">${not empty totalDestinations ? totalDestinations : destinations.size()} Destination(s)</span>
                </div>
            ...
            <c:if test="${not empty totalPages and totalPages >= 1}">
                <nav aria-label="Destination list pagination" class="d-flex justify-content-center mt-4">
                    <ul class="pagination custom-pagination mb-0" style="display: flex !important; list-style: none !important; padding-left: 0 !important; margin: 0 !important;">
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <li class="page-item" style="list-style: none !important;">
                                    <a class="page-link" href="${pageContext.request.contextPath}/admin/destinations?page=${currentPage - 1}&search=${not empty searchKeyword ? searchKeyword : ''}">Previous</a>
                                </li>
                            </c:otherwise>
                        </c:choose>
                        ...
                        <c:forEach var="i" begin="1" end="${totalPages}">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li class="page-item" style="list-style: none !important;">
                                        <a class="page-link" href="${pageContext.request.contextPath}/admin/destinations?page=${i}&search=${not empty searchKeyword ? searchKeyword : ''}">${i}</a>
                                    </li>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <li class="page-item" style="list-style: none !important;">
                                    <a class="page-link" href="${pageContext.request.contextPath}/admin/destinations?page=${currentPage + 1}&search=${not empty searchKeyword ? searchKeyword : ''}">Next</a>
                                </li>
                            </c:otherwise>
                        </c:choose>
                    </ul>
