...
<div class="container-fluid p-0">
            ...
            <form method="POST" action="${pageContext.request.contextPath}/admin/promotions">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" name="startDate" min="2020-01-01" max="2099-12-31" class="form-control rounded-3" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label text-muted small fw-bold">End Date</label>
                        <input type="date" name="endDate" min="2020-01-01" max="2099-12-31" class="form-control rounded-3" required>
                    </div>
        ...
        <section class="table-panel">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <span class="badge bg-primary rounded-pill py-2 px-3">${not empty totalPromotions ? totalPromotions : promotions.size()} Promotion(s)</span>
            </div>
            ...
            <c:if test="${not empty totalPages and totalPages >= 1}">
                <nav aria-label="Promotion list pagination" class="d-flex justify-content-center mt-4">
                    <ul class="pagination custom-pagination mb-0" style="display: flex !important; list-style: none !important; padding-left: 0 !important; margin: 0 !important;">
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <li class="page-item" style="list-style: none !important;">
                                    <a class="page-link" href="${pageContext.request.contextPath}/admin/promotions?page=${currentPage - 1}">Previous</a>
                                </li>
                            </c:otherwise>
                        </c:choose>
                        ...
                        <c:forEach var="i" begin="1" end="${totalPages}">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li class="page-item" style="list-style: none !important;">
                                        <a class="page-link" href="${pageContext.request.contextPath}/admin/promotions?page=${i}">${i}</a>
                                    </li>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <li class="page-item" style="list-style: none !important;">
                                    <a class="page-link" href="${pageContext.request.contextPath}/admin/promotions?page=${currentPage + 1}">Next</a>
                                </li>
                            </c:otherwise>
                        </c:choose>
                    </ul>
